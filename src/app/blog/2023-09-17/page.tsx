...
<>
    ...
    `}</p>
    <p>{"I'll probably post links to new posts on my Twitter (it's not X, no one calls it that), so if you want to keep up to date with this, that's your best bet!"}</p>
    <p>Sincerely, Hazel</p>
</>
